...
import com.example.userservice01.security.models.Authorization;
import com.example.userservice01.security.repos.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        System.out.println("JpaOAuth2AuthorizationService : Initializing with repositories");
    ...
    public void save(OAuth2Authorization authorization) {
        System.out.println("JpaOAuth2AuthorizationService : Saving authorization");
    ...
    public void remove(OAuth2Authorization authorization) {
        System.out.println("JpaOAuth2AuthorizationService : Removing authorization");
    ...
    public OAuth2Authorization findById(String id) {
        System.out.println("JpaOAuth2AuthorizationService : Finding authorization by ID");
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        System.out.println("JpaOAuth2AuthorizationService : Finding authorization by token");
    ...
    private OAuth2Authorization toObject(Authorization entity) {
        System.out.println("JpaOAuth2AuthorizationService : Converting Authorization entity to OAuth2Authorization");
    ...
    private Authorization toEntity(OAuth2Authorization authorization) {
        System.out.println("JpaOAuth2AuthorizationService : Converting OAuth2Authorization to Authorization entity");
    ...
    private void setTokenValues(
        ...
        System.out.println("JpaOAuth2AuthorizationService : Setting token values");
    ...
    private Map<String, Object> parseMap(String data) {
        System.out.println("JpaOAuth2AuthorizationService : Parsing JSON string to metadata map");
    ...
    private String writeMap(Map<String, Object> metadata) {
        System.out.println("JpaOAuth2AuthorizationService : Writing metadata map to JSON string");
    ...
    private static AuthorizationGrantType resolveAuthorizationGrantType(String authorizationGrantType) {
        System.out.println("JpaOAuth2AuthorizationService : Resolving Authorization Grant Type");
